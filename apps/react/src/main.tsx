...
ReactDOM.createRoot(document.body).render(
  <React.StrictMode>
    <BrighttiStreamingProvider config={{
      ...
      HoveringMouse: true, // Either locked mouse, where the pointer is consumed by the video and locked to it, or hovering mouse, where the mouse is not consumed. default: false
      MatchViewportRes: true // Scale the streaming to match Viewport, default: false
    }}>
      <App />
